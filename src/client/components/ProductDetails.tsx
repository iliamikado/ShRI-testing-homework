    ...
    return (
        <div className={bem(null, ['row'])}>
            ...
            <div className="col-12 col-sm-7 col-lg-6">
                ...
                <p data-testid="description" className={bem("Description")}>{product.description}</p>
                ...
                <dl>
                    ...
                    <dt>Material</dt>
                    <dd data-testid="material" className={bem("Material", ['text-capitalize'])}>{product.material}</dd>
                </dl>
            </div>
        </div>
    );
